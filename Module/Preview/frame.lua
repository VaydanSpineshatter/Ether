...
local function configUpdate(preview,input,unit)
    ...
    preview.castBar.text:SetFont(Ether.DB[811][1] or unpack(Ether.mediaPath.expressway),config[2],"OUTLINE")
    preview.castBar.time:SetFont(Ether.DB[811][1] or unpack(Ether.mediaPath.expressway),config[3],"OUTLINE")
end
